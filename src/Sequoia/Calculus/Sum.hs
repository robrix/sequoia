...
sumL1'
  :: (Weaken e r (s e r), Exchange e r (s e r), SumIntro s, Pos a, Pos b)
  => a ⊕ b < _Γ -|s e r|- _Δ
  -- -----------------------
  -> a     < _Γ -|s e r|- _Δ
